...
SelfPlayTournament::SelfPlayTournament(
  ...
  if (game.GetGameResult() != GameResult::UNDECIDED) {
	...
	if(((game_info.game_result == GameResult::WHITE_WON || game_info.game_result == GameResult::BLACK_WON)) &&
	   index_of_first_position_with_k_pieces > game.GetGameTree()->GetPositionHistory().Last().GetGamePly()){
